...
<head>
        ...
        <title>Create Location - BetterChoiceGroupHomes | Admin</title>
                ...
                <main>
                    ...
                    <div class="container-xl px-4 mt-5">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h4 class="fw-bold"><i class="fas fa-map"></i> Add Location</h4>
                        </div>
                            ...
                            <div class="col-md-12 col-lg-4 mx-auto">
                                <div class="card">
                                    <div class="card-body shadow-sm">
                                        <form name="registerlocation">
                                            <div class="mb-3">
                                                <label>Country</label>
                                                <select name="country" id="country" required class="form-select border-0">
                                                    <option value="">Select Country</option>
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                                <label>Address</label>
                                                <input type="text" name="address" required class="form-control border-0 shadow" id="address" placeholder="Enter address" />
                                            </div>
                                            <div class="mb-3"> 
                                                <label>City</label>
                                                <input type="text" name="city" id="city" required class="form-control border-0 shadow" placeholder="Enter city name" />
                                            </div>
                                            <div class="mb-3">
                                                <label>Province</label>
                                                <div class="input-group">
                                                    <input type="text" name="province" id="province" required class="form-control border-0 shadow" placeholder="Enter province" />
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="postal_code" required id="postal_code" class="form-control border-0 shadow" placeholder="Enter postal code" />
                                            </div>
                                            <div class="mb-3">
                                                <label>Geo long</label>
                                                <input type="text" name="longitude" id="longitude" class="form-control border-0 shadow" readonly placeholder="" />
                                            </div>
                                            <div class="mb-3">
                                                <label>Geo lat</label>
                                                <input type="text" name="latitude" id="latitude" class="form-control border-0 shadow" readonly />
                                            </div>
                                            <div class="mb-3">
             ...
             $(function(){
               ...
               // $('.select2').select2();
                ...
                .catch(error => console.error('Error loading countries:', error));
                 ...
                 $("form[name='registerlocation']").validate({
                    ...
                    var data = $("form[name='registerlocation']").serialize();
                    var spinner = document.querySelector(".loader-container");
                    var loadingText = document.querySelector(".loading-text");
                                    ...
                                    $.ajax({
                                        ...
                                        if (data.status===true) {
                                            ...
                                            iziToast.show({
                                                    ...
                                                    buttons: [
                                                        ['<button>View Locations</button>', function (instance, toast) {
