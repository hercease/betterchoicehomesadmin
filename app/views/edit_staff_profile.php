                ...
                <main>
                    ...
                    <div class="container-xl px-4 mt-5">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h4 class="fw-bold"><i class="fas fa-edit"></i> Edit Staff Profile</h4>
                        </div>
                                        ...
                                        loadingText.textContent = "Loading...";
                                            ...
                                            if (res.status) {
                                                ...
                                                iziToast.show({
                                                    ...
                                                    buttons: [
                                                        ['<button>View Details Profile</button>', function () {
                                                            window.location.href = "<?php echo $rootUrl; ?>/userdetails/<?php echo $userId; ?>";
                                                        }],
