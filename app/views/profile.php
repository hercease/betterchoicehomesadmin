...
<head>
        ...
        <title>Profile Details - BetterChoiceGroupHomes | Admin</title>
                ...
                <main>
                    ...
                    <div class="container-xl px-4 mt-5">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h4 class="fw-bold"><i class="fas fa-user"></i> My Profile</h4>
                            <a href="edit_profile"><i class="fas fa-edit"></i> Edit Profile</a>
                        </div>
                        ...
                        <div class="row">
                                    ...
                                    <table class="table table-striped table-borderless">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                   <?php echo $data['user_info']['firstname']; ?> 
                                                </td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Lastname</th>
                                                <td>
                                                    <?php echo $data['user_info']['lastname']; ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th scope="row">City</th>
                                                <td>
                                                    <?php echo $data['user_info']['userdetails']['city']; ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Province</th>
                                                <td>
                                                    <?php echo $data['user_info']['userdetails']['province']; ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Address</th>
                                                <td>
                                                    <?php echo $data['user_info']['userdetails']['address']; ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Contact No</th>
                                                <td>
                                                    <?php echo $data['user_info']['userdetails']['contact_number']; ?>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table table-striped table-borderless">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $data['user_info']['userdetails']['driver_license_number']; ?>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <table class="table table-striped table-borderless">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $data['user_info']['userdetails']['transit_number']; ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Institution No</th>
                                                <td>
                                                    <?php echo $data['user_info']['userdetails']['institution_number']; ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Account No</th>
                                                <td>
                                                    <?php echo $data['user_info']['userdetails']['account_number']; ?>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="col-md-12 col-lg-12 mb-3">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title"><i class="fas fa-file"></i> My Documents</h5>
                                    </div>
                                    <div class="card-body">
    ...
    info: (message, title = "Info") => {
        iziToast.info({
            ...
            close: false
                ...
                var userId = <?php echo json_encode($data['user_info']['id']); ?>;
